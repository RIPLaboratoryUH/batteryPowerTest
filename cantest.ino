...
ODriveCAN odrv3(wrap_can_intf(can_intf), 3); // Standard CAN message ID


//ODriveCAN* odrives[] = {&odrv0}; // Make sure all ODriveCAN instances are accounted for here
ODriveCAN* odrives[] = {&odrv16, &odrv19, &odrv3}; // Make sure all ODriveCAN instances are accounted for here
...
void loop() {
  ...
  if (odrv16_user_data.received_feedback) {
    ...
    Serial.print("odrv16-pos:");
    Serial.print(feedback.Pos_Estimate);
    Serial.print(",");
    Serial.print("odrv16-vel:");
    ...
    odrv16_user_data.received_feedback = false;
    Serial.print("odrv19-pos:");
    Serial.print(feedback.Pos_Estimate);
    Serial.print(",");
    Serial.print("odrv19-vel:");
    Serial.println(feedback.Vel_Estimate);
  }

    if (odrv3_user_data.received_feedback) {
    Get_Encoder_Estimates_msg_t feedback = odrv3_user_data.last_feedback;
    odrv16_user_data.received_feedback = false;
    Serial.print("odrv3-pos:");
    Serial.print(feedback.Pos_Estimate);
    Serial.print(",");
    Serial.print("odrv3-vel:");
    Serial.println(feedback.Vel_Estimate);
  }
